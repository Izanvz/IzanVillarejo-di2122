...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        button_cientifica.setStatusTip('Modo Cientifica')

        button_estandar = QAction("Estandar", self)
        button_estandar.triggered.connect(self.modo_estandar)
        button_estandar.setStatusTip('Modo Estandar')

        button_guardado = QAction("&Guardado", self)
        button_guardado.setCheckable(True)

        button_guardado.triggered.connect(self.Guardado)
        button_guardado.setStatusTip('Activar el guardado auto.')

        button_salir = QAction("Salir", self)
        button_salir.triggered.connect(self.salir)
        button_salir.setStatusTip('Boton para salir')

        # Creamos el statusbar
        self.statusBar = QStatusBar()
        self.setStatusBar(self.statusBar)
        self.statusBar.showMessage("Calculadora Estandar")
        self.statusLabel = QLabel('Guardado desactivado')
        self.statusBar.addPermanentWidget(self.statusLabel)

        if button_guardado.isChecked:
            self.statusLabel.setText("Guardado Activado")
        elif not button_guardado.isChecked:
            self.statusLabel.setText("Guardado Desactivado")
        ...
        for boton, posicion in teclas.items():
            ...
            self.teclas[boton].setStatusTip(boton)
